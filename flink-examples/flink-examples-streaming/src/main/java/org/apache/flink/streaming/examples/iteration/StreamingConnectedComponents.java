...
//		}
//
//		@Overridepackage org.apache.flink.streaming.examples.iteration;
//
//import com.google.common.collect.Lists;
//import org.apache.flink.api.common.typeinfo.BasicTypeInfo;
//import org.apache.flink.api.java.functions.KeySelector;
...
//
//				@Override
//				public void entry(LoopContext<Long, Tuple2<Long, Long>, Long>> ctx, Iterable<Tuple2<Long, List<Long>>> iterable, Collector<Either<Tuple2<Long, Long>, Tuple2<Long, Long>>> collector) {
