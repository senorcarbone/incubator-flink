 ...
 *                                                                  *
 * src: https://github.com/abifet/adwin/blob/master/Java/ADWIN.java *
 ********************************************************************/
...
import org.apache.flink.streaming.paper.adwinPolicies.helper.SizeOf;

import java.io.Serializable;

public class ADWINCombinedPolicy implements TriggerPolicy<Integer>, EvictionPolicy<Integer>, Serializable{

    //***************************************************
    //Flink Windowing Policy Methods
    //***************************************************
    ...
    public boolean notifyTrigger(Integer datapoint) {
        boolean tmp=setInput(datapoint);

        counter++;

        /* //Use this to get debug output
        if (tmp){
            System.out.println("**************");
    ...
    @Override
    public int notifyEviction(Integer datapoint, boolean triggered, int bufferSize) {
        int tmp=latestDelete;
        latestDelete=0;
        ...
        if (tmp>0){
            ...
            System.out.println("Mean:" + getEstimation());
            System.out.println("Variance:" + getVariance());
            System.out.println("Stand. dev:"+Math.sqrt(getVariance()));
            System.out.println("Width:" + getWidth());
            System.out.println("NUM TO DELETE: " + tmp);
            System.out.println("NEW BUFFER SIZE: " + (bufferSize-tmp));
        }
        */
    ...
    /**
     * This is a simplified version of notifyEviction which does not require to send not required parameters.
     * @param datapoint the datapoint
     * @return the number of datapoints to delete from the buffer
     */
    public int notifyEviction(Integer datapoint){
        return this.notifyEviction(datapoint, true, 0);
    }


    //***************************************************
    //Original ADWINCombinedPolicy Methods
    //***************************************************
...
//			temp = this.tail;
    ...
    private class ListItem implements Serializable{
        ...
        protected int MAXBUCKETS= ADWINCombinedPolicy.MAXBUCKETS;
...
//			 object.
    ...
    public int deleteElement(){
        ...
        //Add code to remember amount of deleted [JT]
        this.latestDelete+=n1;
    ...
    public ADWINCombinedPolicy(double d)
    {
        mdbldelta=d;
        initBuckets();
        Detect=0;
    ...
    public ADWINCombinedPolicy(int cl)
    {
        mdbldelta=DELTA;
        initBuckets();
        Detect=0;
