...
public class OptimizedWindowBuffer<T> implements Serializable {
    ...
    public OptimizedWindowBuffer(ReduceFunction<T> reduceFunction, boolean doPreAggregation, boolean keepIndvidualTuples){
    ...
    public void store(final T element) throws Exception {
        ...
        if (doPreAggregation){
            ...
            if (startNewPreAggregation || preAggregations.isEmpty()) {
                ...
                T newValue = this.reduceFunction.reduce(preAggregations.getLast(), element);
    ...
    public T emitWindow(int queryId) throws Exception{
        ...
        Iterator<Integer> descendingIterator=preAggregationStartIds.descendingIterator();
        T result=null;
            ...
            while (descendingIterator.hasNext()) {
                ...
                if (preAggStart >= startId) {
                    ...
                    if (result == null) {
                        ...
                        result = this.reduceFunction.reduce(preAggregations.get(counter),result);
                    }
                    counter--;
                } else {
                    break;
        ...
        //Filling the gap from window start to start of the used pre aggregation
        ...
        for (int i=start;i<end;i++){
            if (result==null) {
                ...
                result = this.reduceFunction.reduce(result,individualTuples.get((int) i));
            }
        }
    ...
    private void deleteExpired(){
        ...
        while (!preAggregations.isEmpty() && preAggregationStartIds.getFirst()<minimum){
