...
/**
 * The base class for all job termination  messages.
 */
public class JobTerminationMessage implements java.io.Serializable {
	...
	public JobTerminationMessage(JobID job, JobVertexID taskVertexID, ExecutionAttemptID taskExecutionId) {
		if (job == null ) {
	...
	protected JobTerminationMessage(JobID job, JobVertexID taskVertexID) {
	...
	public boolean equals(Object o) {
		...
		JobTerminationMessage that = (JobTerminationMessage) o;
